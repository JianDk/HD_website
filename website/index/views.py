...
def index(request):
    context = {'shopTitle' : 'Hidden Dimsum',
...
def hd2900(request):
    ...
    if request.method == 'POST':
        ...
        if form.is_valid():
            ...
            print('news letter form is good proceed')
        ...
        # 'addressStreet' : 'Strandvejen 163',
        # 'addressPostcodeCity' : '2900 Hellerup',
        # 'addressPhone' : '+45-40 38 88 84',
        # 'addressEmail' : 'kontakt@dimsum.dk',
        # 'addressCVR' : 'CVR: 38908901',
        'dayRange1' : 'Monday - Sunday',
